...
<head>
    ...
    <title>Editar Slide -  Belle Vie</title>
...
<body>
	<header>
    	<h1>Administrador - Editar Slide</h1>
    ...
    <div id="breadcrumb">
    	<ul>
            ...
            <li><a href="editar/edita_slide.php">Edita Slide</a></li>
        </ul>
    </div><!--breadcrumb-->
    <nav>
    	<ul>
	...
	<section id="conteudo">
        <aside>
    		<h3>Dicas</h3>
            <p>Aqui você adicionar editar slides da página principal</p>
    	</aside>
        <article>
        	<h2>Editar Slide</h2>
            <?php $id=$_GET['id']; ?>
            <form method="post"  action="../../acoes/edita/edita_slide.php?id=<?php echo $id; ?>" enctype="multipart/form-data">              
