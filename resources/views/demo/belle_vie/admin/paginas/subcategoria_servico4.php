...
<body>
	...
	<section id="conteudo">
        <div id="wrap_menu_direito">
            <nav id="menu_direito">
                <ul>
                    <li class="odd"><a href="incluir/inclui_subcategoria_servico4.php">Incluir Sub Categoria</a></li>
                    <?php
						...
						{
						  echo '<li><a href="incluir/inclui_conteudo_servico4.php?id_subcategoria='.$linha['id'].'">'.$linha['nome'].'</a></li>';										  
						}
					?>	
