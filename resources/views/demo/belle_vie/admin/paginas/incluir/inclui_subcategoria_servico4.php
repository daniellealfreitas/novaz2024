...
<body>
    ...
    <div id="breadcrumb">
    	<ul>
            ...
            <li><a href="inclui_subcategoria_servico4.php">Incluir Subcategoria</a></li>
        </ul>
    </div><!--breadcrumb-->
    <nav>
    	<ul>
	...
	<section id="conteudo">
        ...
        <article>
            ...
            <form method="post"  action="../../acoes/inclui/inclui_subcategoria4.php" enctype="multipart/form-data">              
        	...
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:10px;"><strong>Deletar</strong></td>
				  ...
				  <?php
                  $sql = "SELECT * FROM categorias_servico4 ORDER BY id DESC";
                  $resultado = mysql_query($sql)
                  or die ("Não foi possível realizar a consulta.");
                  while ($linha=mysql_fetch_array($resultado))
                  {
					  ...
					  echo $linha['nome'];
					  echo "</td>";
                      echo "<td><a href='../../acoes/exclui/exclui_categoria_servico4.php?id={$linha['id']}'>";
