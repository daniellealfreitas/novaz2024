...
function Verifica_Upload()
{
        ...
        function gera_fotos()
        {
				...
				$query = "UPDATE `fotos_conteudo_servicos3` SET `id_subcategoria` = '$id_subcategoria', `nome_foto` = '$nome_foto', `nome_thumb` = '$nome_thumb' WHERE `fotos_conteudo_servicos3`.`id_subcategoria` = ".$id_subcategoria.";";
