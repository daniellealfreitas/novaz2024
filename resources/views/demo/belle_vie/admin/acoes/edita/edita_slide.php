...
function Verifica_Upload()
{
        ...
        function gera_fotos()
        {
				...
				reduz_imagem($this->arquivo['tmp_name'], 920, 300, $diretorio.$nome_foto);               
				...
				$query = "UPDATE `slides` SET `id` = '$id', `nome_foto` = '$nome_foto', `thumb_foto` = '$nome_thumb' WHERE `slides`.`id` = ".$id."";
